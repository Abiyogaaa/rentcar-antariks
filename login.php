            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Don't have an account? <a data-toggle="modal" data-target="#modelId" class="font-bold">Sign
                                up</a>.</p>
                ...
                <div class="modal-body">
                    <form method="post" action="koneksi/proses.php?id=daftar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="notlp" id="" class="form-control" required placeholder="" aria-describedby="helpId">
                        </div>
                </div>
